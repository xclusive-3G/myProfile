...
const Experience = () => {
        ...
        <div name="experience" className=' bg-gradient-to-b  from-black to-gray-800  h-full'>
            <div className='md:max-w-screen-md lg:max-w-screen-xl mx-auto px-6 py-14 flex-col justify-center w-full h-full '>
                ...
                <div className=' justify-center items-center w-full  grid gird-cols-2 sm:grid-cols-3 px-4 text-center py-8 gap-8 '>
