    ...
    return (
       ...
       /*work on the over flow on x */
        <div name="contact" className=' w-full h-full bg-gradient-to-b from-gray-800 to-black'>
            <div className='flex flex-col px-4 py-16 justify-center items-center mx-auto  w-3/4 h-full '>
                ...
                <div>   
                    <form action='https://getform.io/f/pboxrkya' method='POST' className=' flex flex-col w-full '>
